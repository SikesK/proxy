...
def room_to_rgb(room, room_structure=None):
    ...
    power_down_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'button_off.jpg')))
    power_down = imageio.imread(power_down_filename)

    power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'button_on.jpg')))
    #power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    power_up = imageio.imread(power_up_filename)

    # X1 to X9
    x1_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x1.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x1 = imageio.imread(x1_file)

    x2_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x2.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x2 = imageio.imread(x2_file)
    x3_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x3.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x3 = imageio.imread(x3_file)
    x4_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x4.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x4 = imageio.imread(x4_file)
    x5_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x5.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x5 = imageio.imread(x5_file)
    x6_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x6.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x6 = imageio.imread(x6_file)
    x7_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x7.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x7 = imageio.imread(x7_file)
    x8_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'x8.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    x8 = imageio.imread(x8_file)

    y1_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y1.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y1 = imageio.imread(y1_file)
    y2_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y2.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y2 = imageio.imread(y2_file)
    y3_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y3.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y3 = imageio.imread(y3_file)
    y4_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y4.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y4 = imageio.imread(y4_file)
    y5_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y5.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y5 = imageio.imread(y5_file)
    y6_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y6.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y6 = imageio.imread(y6_file)
    y7_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y7.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y7 = imageio.imread(y7_file)
    y8_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'y8.jpg')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    y8 = imageio.imread(y8_file)

    blank_file = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'blank.png')))
    # power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    blank = imageio.imread(blank_file)




    surfaces = [wall, floor, box_target, box_on_target, box, player, player_on_target, power_down, power_up] + \
               [x1, x2, x3, x4, x5, x6, x7, x8] + [y1, y2, y3, y4, y5, y6, y7, y8] + [blank]
...
#    surfaces = [wall, floor, box_target, box_on_target, box, player, player_on_target]
    power_down_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'power_down.png')))
    power_down = imageio.imread(power_down_filename)

    power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'power_on.png')))
    #power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    power_up = imageio.imread(power_up_filename)
